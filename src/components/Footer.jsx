  ...
  return (
    <footer className="border-t border-hairline-dark bg-ink text-paper/80">
      <Reveal className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 md:grid-cols-3">
        ...
        <div>
          <p className="font-mono text-xs font-medium uppercase tracking-[0.16em] text-brass-light">Contact</p>
          <ul className="mt-4 space-y-3 text-sm text-paper/70">
            <li className="flex items-center gap-3">
              <Phone size={16} className="shrink-0 text-brass-light" aria-hidden="true" />
              (555) 123-4567
            </li>
            <li className="flex items-center gap-3">
              <Mail size={16} className="shrink-0 text-brass-light" aria-hidden="true" />
              info@saelitehomeinspection.com
            </li>
            <li className="flex items-center gap-3">
              <MapPin size={16} className="shrink-0 text-brass-light" aria-hidden="true" />
        ...
        <div>
          <p className="font-mono text-xs font-medium uppercase tracking-[0.16em] text-brass-light">Hours</p>
          <ul className="mt-4 space-y-3 text-sm text-paper/70">
            <li className="flex items-center gap-3">
              <Clock size={16} className="shrink-0 text-brass-light" aria-hidden="true" />
